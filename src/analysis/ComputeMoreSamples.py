...
if which == "sine" or which == "helm":
    ...
    shape = (68, 20)
    if which == "sine":
        from datasets.PoissonSin200L import PoissonSin200LDataset as MyDataset1
        from datasets.PoissonSin200L import PoissonSin200LDataset as MyDataset2
        from datasets.PoissonSin200L import PoissonSin200LDataset as MyDataset3
    if which == "helm":
        from datasets.Helm32L import Helm32LDataset as MyDataset1
        from datasets.Helm32L import Helm32LDataset as MyDataset2
        from datasets.Helm32L import Helm32LDataset as MyDataset3
# %%
if which == "sine":
